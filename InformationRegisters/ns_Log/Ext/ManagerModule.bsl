Функция ЗаписатьОшибку(Событие, КонтекстОшибки = Неопределено) Экспорт
	Возврат ЗаписатьЛог(Перечисления.ns_УровниЛога.Ошибка, Событие, КонтекстОшибки);		
КонецФункции

Функция ЗаписатьИнформацию(Событие, КонтекстОшибки = Неопределено) Экспорт
	Возврат ЗаписатьЛог(Перечисления.ns_УровниЛога.Информация, Событие, КонтекстОшибки);		
КонецФункции
...
Функция ЗаписатьЛог(УровеньЛога, Событие, КонтекстОшибки)
	...
	Попытка
		МенеджерЗаписи = РегистрыСведений.ns_Log.СоздатьМенеджерЗаписи();
